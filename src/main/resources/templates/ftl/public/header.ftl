...
<header class="main-header">
    <!-- Logo -->
    <a href="http://www.lazycode.vip" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>L</b>azy</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Admin</b>LAZY</span>
    </a>
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li><!-- start message --> <a href="#">
                                    <div class="pull-left"><img src="${ctx}/static/img/user2-160x160.jpg" class="img-circle" alt="User Image"></div>
                                    <h4> 团队支持
                                        <small><i class="fa fa-clock-o"></i> 5 mins</small>
                                    </h4>
                                    <p>为什么要买呢？</p></a></li> <!-- end message -->
                            </ul>
                        </li>
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <!-- inner menu: contains the actual data -->
                            <ul class="menu"> <!--提醒  开始-->
                                <li><a href="#"> <i class="fa fa-users text-aqua"></i> 小组会议 2017-10-17 10:00:00 </a></li> <!--提醒  结束-->
                            </ul>
                        </li>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <p> 系统管理员
                                <small>system</small>
                                <small>最后登录时间：2017-10-16 21:00:00</small>
                            </p>
                        </li>
                        <!-- Menu Body -->
                        <li class="user-body">
                        ...
                        <li class="user-footer">
                            <div class="pull-left"><a href="#" class="btn btn-default btn-flat">设置</a>
                            </div>
